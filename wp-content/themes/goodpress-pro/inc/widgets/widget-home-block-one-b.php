 ...
 * @since      1.0.0
 */
class goodpress_Block_One_B_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-goodpress-home-block-one-b',
			'description' => __( 'Display one-column post blocks. Only use for the "Homepage Content" widget area.', 'goodpress-pro' )
		);

		// Create the widget.
		parent::__construct(
			'happythemes-home-block-one-b',          // $this->id_base
			__( '&raquo; Home One Column Type B', 'goodpress-pro' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			$query = apply_filters( 'goodpress_home_one_b_column_args', $args );
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'cat' ); ?>"><?php _e( 'Choose category', 'goodpress-pro' ); ?></label>
 ...
 * @since 1.0.0
 */
function goodpress_home_one_b_column_meta() {
	...
	$html = '<div class="entry-meta">';
		...
		if ( $category && goodpress_categorized_blog() ) {
