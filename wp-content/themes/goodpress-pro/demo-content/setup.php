 ...
 * Set import files
 */
function goodpress_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Demo content', 'goodpress-pro'),
...
add_filter( 'pt-ocdi/import_files', 'goodpress_set_import_files' );

/**
 * Define actions that happen after import
 */
function goodpress_set_after_import_mods() {
...
add_action( 'pt-ocdi/after_import', 'goodpress_set_after_import_mods' );
