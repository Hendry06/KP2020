 ...
 * @since      1.0.0
 */
class goodpress_Block_Two_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-goodpress-home-two-columns',
			'description' => __( 'Display two-column post blocks. Only use for the "Homepage Content" widget area.', 'goodpress-pro' )
		);

		// Create the widget.
		parent::__construct(
			'happythemes-home-two-columns',         // $this->id_base
			__( '&raquo; Home Two Columns', 'goodpress-pro' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			echo '<div class="content-block content-block-2 clear">';
				...
				// Column first post
				goodpress_home_posts_first( $args, $instance );

				// Column first post
				goodpress_home_posts_second( $args, $instance );
 ...
 * Column first posts
 */
function goodpress_home_posts_first( $args, $instance ) {
	...
	$query = apply_filters( 'goodpress_home_two_columns_1_args', $args );
 ...
 * Column second posts
 */
function goodpress_home_posts_second( $args, $instance ) {
	...
	// Allow dev to filter the post arguments.
	$query = apply_filters( 'goodpress_home_two_columns_2_args', $args );
