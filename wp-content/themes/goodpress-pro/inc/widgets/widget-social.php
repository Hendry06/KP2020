 ...
 * @since      1.0.0
 */
class goodpress_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-goodpress-social widget_social_icons',
			'description' => __( 'Display your social media icons.', 'goodpress-pro' )
		);

		// Create the widget.
		parent::__construct(
			'goodpress-social',                        // $this->id_base
			__( '&raquo; Social Icons', 'goodpress-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Follow Us', 'goodpress-pro' ),
			'desc'       => esc_html__( 'Stay updated via social channels', 'goodpress-pro' ),		
			'facebook'   => '',
			'twitter'    => '',
			'gplus'      => '',
			'pinterest'  => '',
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>">
				<?php _e( 'Description', 'goodpress-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'gplus' ); ?>">
				<?php _e( 'Google Plus', 'goodpress-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'pinterest' ); ?>">
				<?php _e( 'Pinterest', 'goodpress-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'instagram' ); ?>">
				<?php _e( 'Instagram', 'goodpress-pro' ); ?>
			</label>
