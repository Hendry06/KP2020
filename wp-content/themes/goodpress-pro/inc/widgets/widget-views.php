 ...
 * @since      1.0.0
 */
class goodpress_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-goodpress-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'goodpress-pro' )
		);

		// Create the widget.
		parent::__construct(
			'goodpress-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'goodpress-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'goodpress-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
