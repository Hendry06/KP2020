 ...
 * @since      1.0.0
 */
class goodpress_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-goodpress-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'goodpress-pro' )
		);

		// Create the widget.
		parent::__construct(
			'goodpress-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'goodpress-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'goodpress-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
