...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'goodpress-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'goodpress-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'goodpress-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'goodpress-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'goodpress-pro' ),
		'devanagari'   => __( 'Devanagari', 'goodpress-pro' ),
		'greek'        => __( 'Greek', 'goodpress-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'goodpress-pro' ),
		'khmer'        => __( 'Khmer', 'goodpress-pro' ),
		'latin'        => __( 'Latin', 'goodpress-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'goodpress-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'goodpress-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'goodpress-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'goodpress-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'goodpress-pro' ),
