 ...
 * @since      1.0.0
 */
class goodpress_Newsletter_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display newsletter subscribe form.', 'goodpress-pro' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'goodpress-newsletter',                                    // $this->id_base
			esc_html__( '&raquo; Newsletter', 'goodpress-pro' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>">
				<?php esc_html_e( 'Title', 'goodpress-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'form_code' ); ?>">
				<?php esc_html_e( 'Subscribe Form Code', 'goodpress-pro' ); ?> <span style="display: block;color: #999;">See <a href="https://www.happythemes.com/demo/goodpress-pro/wp-content/themes/goodpress-pro/form-example.txt" target="_blank">example code</a>.</span>
			</label>
