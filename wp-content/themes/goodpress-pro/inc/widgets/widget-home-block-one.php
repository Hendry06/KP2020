 ...
 * @since      1.0.0
 */
class goodpress_Block_One_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-goodpress-home-block-one',
		...
		parent::__construct(
			...
			__( '&raquo; Home One Column Type A', 'goodpress-pro' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			$query = apply_filters( 'goodpress_home_one_column_args', $args );
 ...
 * @since 1.0.0
 */
function goodpress_home_one_column_meta() {
