  ...
  jQuery.ajax({
    ...
    success: function (response) {
      ...
      if (data[0]['TotalSoftGalleryV_SetType'] == 'Grid Video Gallery') {
        ...
        if (data[0]['TotalSoft_GV_FG_PT'] == 'true') {
          data[0]['TotalSoft_GV_FG_PT'] = true;
        } else {
          data[0]['TotalSoft_GV_FG_PT'] = false;
        }
        if (data[0]['TotalSoft_GV_FG_PD'] == 'true') {
          data[0]['TotalSoft_GV_FG_PD'] = true;
        } else {
          data[0]['TotalSoft_GV_FG_PD'] = false;
        }
        ...
        jQuery('#TotalSoft_GV_FG_PT').attr('checked', data[0]['TotalSoft_GV_FG_PT']);
        jQuery('#TotalSoft_GV_FG_PD').attr('checked', data[0]['TotalSoft_GV_FG_PD']);
...
function TS_GV_Theme_Preview_T() {
  ...
  if (TotalSoftGalleryV_SetType == 'Grid Video Gallery') {
    ...
    var TotalSoft_GV_FG_PT = jQuery('#TotalSoft_GV_FG_PT').attr('checked');
    var TotalSoft_GV_FG_PD = jQuery('#TotalSoft_GV_FG_PD').attr('checked');
